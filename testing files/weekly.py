...
def MovingAverageCrossStrategy(stock_symbol, start_date='2018-01-01', end_date='2020-01-01',
                               short_window=9, long_window=26, moving_avg='SMA',display_graph = False, display_table=True):
    '''
...
df_action = MovingAverageCrossStrategy('HDFC.NS','2018-01-01','2022-04-01',9,26,'EMA',True)

profit = (df_action.loc[df_action['Position'] == 'Sell', 'Close Price'].sum()) - (df_action.loc[df_action['Position'] == 'Buy', 'Close Price'].sum())

if df_action.iloc[-1][4] == "Buy":
    profit += df_action.iloc[-1][0]
